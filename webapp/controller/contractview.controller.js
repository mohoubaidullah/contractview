...
], function (Controller, Fragment, Filter, MessagePopover, MessageBox, MessagePopoverItem, FilterOperator, MessageToast, SimpleType, ValidateException) {
	"use strict";

	return Controller.extend("zsd.contractview.controller.contractview", {
			onInit: function () {
			debugger;
			...
			this.getView().byId("idMobile").setEditable(false);
				this.getView().byId("idEmail").setEditable(false);
					...
					this.getView().byId("idOutlets").setEditable(false);
					this.getView().byId("idPostal").setEditable(false);
		...
		//	this.getView().byId("idEditQtyValue").setVisible(true);
			...
			oModel.read(sPath, {
				success: function (oData, response) {
					...
					that.getView().byId("idContactName").setValue(oModel3.oData.Zcontact);
					that.getView().byId("idBrandNameAr").setValue(oModel3.oData.Zbrand);
					that.getView().byId("idBrandNameAr").setValue(oModel3.oData.Zbrandname);
					that.getView().byId("idTele").setValue(oModel3.oData.Zlandline);
					that.getView().byId("idMobile").setValue(oModel3.oData.Zmobile);
					that.getView().byId("idEmail").setValue(oModel3.oData.Zemail);
					that.getView().byId("idRep").setValue(oModel3.oData.Zrep);
					that.getView().byId("idRep").setValue(oModel3.oData.Zrep);
					that.getView().byId("idRepDescr").setText(oModel3.oData.Zsalesrepname);
					that.getView().byId("idEmpId").setValue(oModel3.oData.Zemployee);
					that.getView().byId("idEmpDescr").setText(oModel3.oData.Zempname);
					that.getView().byId("idPostal").setValue(oModel3.oData.Zpostal);
		...
		onValueHelpRequest: function (oEvent) {
			...
			if (!this._valueHelpDialog) {
				this._valueHelpDialog = sap.ui.xmlfragment(
					"zsd.contractview.fragments.ValueHelpDialog",
					this
				);
		...
		onValueHelpRequestSoff: function (oEvent) {
			...
			if (!this._valueHelpDialogSoff) {
				this._valueHelpDialogSoff = sap.ui.xmlfragment(
					"zsd.contractview.fragments.ValueHelpDialogSoff",
					this
				);
		...
		onValueHelpRequestChannel: function (oEvent) {
			...
			if (!this._valueHelpDialogChannel) {
				this._valueHelpDialogChannel = sap.ui.xmlfragment(
					"zsd.contractview.fragments.ValueHelpDialogChannel",
					this
				);
		...
		onValueHelpRequestDivison: function (oEvent) {
			...
			if (!this._valueHelpDialogDivison) {
				this._valueHelpDialogDivison = sap.ui.xmlfragment(
					"zsd.contractview.fragments.ValueHelpDialogDivison",
					this
				);
		...
		onValueHelpRequestRep: function (oEvent) {
			...
			if (!this._valueHelpDialogRep) {
				this._valueHelpDialogRep = sap.ui.xmlfragment(
					"zsd.contractview.fragments.ValueHelpDialogRep",
					this
				);
		...
		onSave: function (oEvent) {
			...
			if (Ztempid !== "") {
				...
				if (Zarea !== "" && ZnameEn !== "" && ZnameAr !== "" && Zmobile !== "" && Zstreet !== "" && Zcity !== "" && Zsalesoffice !==
					"" &&
					Zchannel !== "" && Zspart !== "" && Zrep !== "" && Zroute !== "" && Zoutlets !== "") {
				...
				oModel.read(sPath, {
					success: function (oData, response) {
						...
						if (!that.displayContent) {
							that.displayContent = sap.ui.xmlfragment("zsd.contractview.fragments.filepreview", that);
